...
-- CreateIndex
CREATE INDEX "LiteLLM_SpendLogs_model_group_cache_hit_startTime_api_base_idx" ON "LiteLLM_SpendLogs"("model_group", "cache_hit", "startTime", "api_base");

-- CreateIndex
CREATE INDEX "LiteLLM_SpendLogs_model_group_cache_hit_api_key_startTime_idx" ON "LiteLLM_SpendLogs"("model_group", "cache_hit", "api_key", "startTime");

-- CreateIndex
CREATE INDEX "LiteLLM_SpendLogs_model_group_cache_hit_end_user_startTime_idx" ON "LiteLLM_SpendLogs"("model_group", "cache_hit", "end_user", "startTime");
